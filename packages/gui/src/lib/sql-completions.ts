...
const SQL_KEYWORDS = [
	...
	"OFFSET", "DISTINCT", "UNION", "ALL", "INTERSECT", "EXCEPT",
	"CREATE", "ALTER", "DROP", "TABLE", "INDEX", "VIEW", "SCHEMA",
	"PRIMARY", "KEY", "FOREIGN", "REFERENCES", "UNIQUE", "CHECK",
	"DEFAULT", "CASCADE", "RESTRICT", "RETURNING", "WITH", "RECURSIVE",
	"CASE", "WHEN", "THEN", "ELSE", "END", "COALESCE", "NULLIF",
	"CAST", "TRUE", "FALSE", "ASC", "DESC", "FETCH", "FIRST", "LAST",
	"COUNT", "SUM", "AVG", "MIN", "MAX", "ARRAY_AGG", "STRING_AGG",
	"ROW_NUMBER", "RANK", "DENSE_RANK", "OVER", "PARTITION",
	"WINDOW", "LATERAL", "UNNEST", "GENERATE_SERIES",
];
