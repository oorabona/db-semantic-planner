...
|------|:------------:|:----------:|-------------|
| **Prisma** | 45k+ | 9M+ | Schema-first ORM with auto-generated client, migrations, studio UI |
| **TypeORM** | 36k+ | 4M+ | Full ORM with decorators, Active Record & Data Mapper patterns |
| **Sequelize** | 30k+ | 2M+ | Mature ORM, Promise-based, feature-rich but verbose |
| **Knex.js** | 20k+ | 4M+ | SQL query builder, foundation for many ORMs, excellent flexibility |
| **Drizzle** | 33k+ | 6M+ | Modern TypeScript ORM, SQL-like syntax, no codegen |
| **Kysely** | 13k+ | 3M+ | Type-safe SQL query builder, minimal overhead |

### Tier 2 - Specialized

| Tool | GitHub Stars | npm weekly | Description |
|------|:------------:|:----------:|-------------|
| **MikroORM** | 9k+ | 100k+ | TypeScript ORM with Unit of Work, Identity Map, DDD patterns |
