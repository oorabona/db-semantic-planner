...
function getSpecificMessage(reference, lang) {
  var _a2;
  return (_a2 = store$1 == null ? void 0 : store$1.get(reference)) == null ? void 0 : _a2.get(lang);
}
function deleteSpecificMessage(reference, lang) {
  var _a2;
  (_a2 = store$1 == null ? void 0 : store$1.get(reference)) == null ? void 0 : _a2.delete(lang);
}
function _stringify(input) {
  ...
  if (type === "object" || type === "function") return (input && ((_b = (_a2 = Object.getPrototypeOf(input)) == null ? void 0 : _a2.constructor) == null ? void 0 : _b.name)) ?? "null";
  return type;
}
...
function parseJson(config$1, message$1) {
  return {
    ...
    "~run"(dataset, config$2) {
      var _a2;
      try {
        dataset.value = JSON.parse(dataset.value, (_a2 = this.config) == null ? void 0 : _a2.reviver);
      } catch (error) {
...
function _isPartiallyTyped(dataset, paths) {
  ...
  if (dataset.issues) for (const path of paths) for (const issue of dataset.issues) {
    let typed = false;
    const bound = Math.min(path.length, ((_a2 = issue.path) == null ? void 0 : _a2.length) ?? 0);
...
function stringifyJson(config$1, message$1) {
  return {
    ...
    "~run"(dataset, config$2) {
      var _a2, _b;
      try {
        const output = JSON.stringify(dataset.value, (_a2 = this.config) == null ? void 0 : _a2.replacer, (_b = this.config) == null ? void 0 : _b.space);
        if (output === void 0) {
...
var __LruCache_instances, stringify_fn, _a;
var _LruCache = (_a = class {
  constructor(config$1) {
    __privateAdd(this, __LruCache_instances);
    this.refCount = 0;
  ...
  */
  key(input, config$1 = {}) {
    return `${__privateMethod(this, __LruCache_instances, stringify_fn).call(this, input)}|${__privateMethod(this, __LruCache_instances, stringify_fn).call(this, config$1.lang)}|${__privateMethod(this, __LruCache_instances, stringify_fn).call(this, config$1.message)}|${__privateMethod(this, __LruCache_instances, stringify_fn).call(this, config$1.abortEarly)}|${__privateMethod(this, __LruCache_instances, stringify_fn).call(this, config$1.abortPipeEarly)}`;
  }
  /**
...
}, __LruCache_instances = new WeakSet(), /**
