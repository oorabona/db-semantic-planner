...
import type { Schema, RelationDefinition } from '@dbsp/schema';
import { inferRelations } from '@dbsp/schema';
...
import type { ModelIR } from '@dbsp/core/internal';
...
export type { Schema } from '@dbsp/schema';
`;
}
...
import type { Schema, ColumnDefinition } from '@dbsp/schema';
import { writeFile, mkdir } from 'fs/promises';
import { join } from 'path';
...
import type { Schema } from '@dbsp/schema';
import type { ModelIR } from '@dbsp/core/internal';
...
import pg from 'pg';
import type { Schema, ColumnType } from '@dbsp/schema';
